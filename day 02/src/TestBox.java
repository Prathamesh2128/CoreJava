...
class TestBox
{
	public static void main(String[] args)
	{
		...
		System.out.println("Enter side of a cube : side");
		
		Box cube = new Box(sc.nextDouble());
		System.out.println(cube.getBoxDetails());
		System.out.println("Computed Volume is : "+cube.getComputedVolume());
		
		Box emptyBox = new Box();
		System.out.println(emptyBox.getBoxDetails());
		System.out.println("Computed Volume is : "+emptyBox.getComputedVolume());
		sc.close();
	}
}